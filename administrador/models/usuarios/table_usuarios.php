...
for ($i = 0; $i < count($consulta); $i++) { 
	...
	$consulta[$i]['acciones'] = 
	'
	<button class="btn btn-primary" title="Editar" oneclick="editarUsuario('.$consulta[$i]['usuario_id'].')">Editar</button>
	<button class="btn btn-danger" title="Eliminar" oneclick="eliminarUsuario('.$consulta[$i]['usuario_id'].')">Eliminar</button>
	';
}
